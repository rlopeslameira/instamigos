  ...
  return (
      <div className="shadow-sm border-b bg-white sticky z-50">
        <div className="flex justify-between bg-white max-w-6xl mx-5 xl:mx-auto">
            <div onClick={() => route.push('/')} className="relative hidden lg:inline-grid w-28 cursor-pointer">
                <Image  src="/images/logo.png" layout="fill" objectFit="contain"/>
            </div>

            <div onClick={() => route.push('/')} className="relative w-10 lg:hidden cursor-pointer">
                <Image src="/images/instagram.png" layout="fill" objectFit="contain"/>
            </div>
            ...
            <div className="flex items-center justify-end space-x-4">
                ...
                {session ? (
                    <>
                        ...
                        <img onClick={signOut} src={session.user.image} className="h-10 w-10 rounded-full hidden md:inline-grid cursor-pointer"/>
                    </>
                ) : (
